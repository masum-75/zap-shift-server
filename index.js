  ...
  try {
    ...
    app.post("/payment-checkout-session", async (req, res) => {
      ...
      const session = await stripe.checkout.sessions.create({
        line_items: [
          {
            price_data: {
              ...
              unit_amount: amount,
              product_data: {
                name: `pay for this : ${paymentInfo.parcelName}`,
              },
            },
            quantity: 1,
          },
        ...
        success_url: `${process.env.WEB_SECRET}/dashboard/payment-success?session_id={CHECKOUT_SESSION_ID}`,
